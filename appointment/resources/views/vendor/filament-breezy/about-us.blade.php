    ...
    <div class="section">
        <div class="container">
			...
			<div class="content-section-container">
				...
				<div class="content">
					<h3>Vision</h3>
					<p>Our vision is to create a lasting relationship with our patients through dental care that is based on confidence, trust, high-quality work, and outstanding patient care. We aim to be the best clinic in terms of getting appointments done efficiently.</p>
				</div>
				<div class="content">
					<h3>Values</h3>
					<p>Our values are to make each patient’s dental experience as comfortable and stress-free as possible, treat every patient as if they are a member of our family, provide our patients with the best dental care possible using state-of-the-art techniques and technology, and strive to be the top-rated dental office in the area.</p>
				</div>
			</div>
